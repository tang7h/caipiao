...
<form id="theForm" name="theForm" method="post" action="" onSubmit="return chk(this)" runat="server" class="register-form" ng-controller="loginCtrl">
	...
	<div class="form-group">
		<label class="hide" for="member_password">密码<span>*</span></label>
	...
	<div class="form-group">
		<label class="hide" for="pass">确认密码<span>*</span></label>
	...
	<div class="form-group">
		...
		<input class="form-control input-lg" name="member_cid" type="text" id="member_cid" maxlength="20" placeholder="身份证号码" />
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<input class="md-btn md-btn-primary btn-block" type="submit" name="submit" id="submit" value="注册" maxlength="20"/>
	</div>
...
<form action="" method="post" name="regform" onSubmit="return Checklogin();" class="login-form" ng-controller="loginCtrl">
  ...
  <div class="form-group">
	<label class="hide" for="exampleInputPassword1">密码</label>
	<input type="password" class="form-control input-lg" id="password" name="password" placeholder="密码">
  </div>
  <div class="form-group">
	<input  type="submit" name="submit2" value="登录" class="md-btn md-btn-primary md-btn-large"/>
  </div>
