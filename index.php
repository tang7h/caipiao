...
<body>
	...
	<div class="section-scroll-ad">
		<div id="carousel-top" class="carousel slide" data-ride="carousel" data-interval="3000">
			...
			<div class="carousel-inner">
				<div class="active carousel-item">carousel 1</div>
				<div class="carousel-item">carousel 2</div>
				<div class="carousel-item">carousel 3</div>
			</div>
		</div>
	</div>
	...
	<!-- 文章列表 -->
	<div class="article-list section with-padding with-margin">
	...
	<div class="section-bottom">
		<div class="nav-bottom">
			<div class="nav-bottom-item">
				<div class="icon">
					<img src="images/iconfont-clock-03.png">
				</div>
